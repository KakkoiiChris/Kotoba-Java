...
package kakkoiichris.kotoba.data.json.lexer;

import kakkoiichris.kotoba.data.json.JsonNull;
...
public class Lexer implements Iterator<Token> {
    ...
    private Token.Type getSymbol() {
        ...
        if (skip('[')) {
            return Token.Type.LEFT_SQUARE;
        }

        if (skip(']')) {
            return Token.Type.RIGHT_SQUARE;
        }
